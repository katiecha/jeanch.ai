  ...
  return (
    <main className="relative w-screen h-[100dvh] overflow-hidden touch-none">
      ...
      <Link
        ...
        className="absolute top-6 left-1/2 -translate-x-1/2 z-10 text-[9px] font-mono tracking-[0.8em] uppercase text-white/60 hover:text-white transition-colors whitespace-nowrap"
      >
        Happy Father&apos;s Day
      </Link>
              ...
              {Object.entries({
                ...
                <g key={id}>
                  <rect
                    ...
                    height={12}
                    fill="#002147"
                    fillOpacity={id === "happy-fathers-day" ? 0.28 : 0.82}
                  />
                </g>
              ))}
            </svg>
